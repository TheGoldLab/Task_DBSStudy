...
topNode.addHelpers('message', 'topNodeMessages');
...
for ii = 1:2:length(taskSpecs)
   ...
   args = {taskSpecs{ii},                 ...
      ...
      'taskID',                           (ii+1)/2, ...
      'taskTypeID',  find(strcmp(taskSpecs{ii}, {'VGS' 'MGS' 'Quest' 'NN' 'NL' 'NR' 'SN' 'SL' 'SR' 'AN' 'AL' 'AR' 'SB'}),1)};
